...
EXPECTED_SHA="9ecdde16fa35acfc3b4603dd2e6c0055770391a2"
EXPECTED_VERSION="2.5.81"
RUN_ROOT="${RUNNER_TEMP:-/tmp}/p02-v2581-r1-${GITHUB_RUN_ID:-local}-$$"
SITE="$RUN_ROOT/site"
COOKIE="$RUN_ROOT/cookies.txt"
PORT=18281
BASE_URL="http://127.0.0.1:$PORT"
TEST_PASSWORD="P02-R1-${GITHUB_RUN_ID:-local}-Safe!"
mkdir -p "$RUN_ROOT"
...
cp "$GITHUB_WORKSPACE/runner/requests/p02-v2581-r1/browser.mjs" "$PRODUCT_ROOT/tests/e2e/p02_v2581_r1_temp.mjs"
export VF_R1_BASE_URL="$BASE_URL"
export VF_R1_PASSWORD="$TEST_PASSWORD"
node tests/e2e/p02_v2581_r1_temp.mjs
