...
def main():
    ...
    notes.write_text(
        f"# VF Library V{version}\n\n"
        "Inkstone primary-reference UX/UI convergence release. "
        "This release consolidates the post-V2.5.41 UX work into one formal update: Inkstone-scale desktop shell proportions, quiet rounded note rows, denser full-library lists, application-style Settings forms, compact workspace and sidebar commands, improved new-editor empty state, standalone reader convergence, Scratch workspace convergence, and mobile list-first library flow. "
        "Wide desktop editing preserves note-list continuity while medium desktop yields space to the document; editor outline is shown only when useful. "
        "The private single-admin product model, Canonical Content authority, authentication boundary, updater contract and Schema 2401 remain unchanged; no migration is required.\n\n"
