...
def main():
    ...
    notes.write_text(
        f"# VF Library V{version}\n\n"
        "Inkstone-class workbench hotfix release. "
        "Settings child confirmations and prompts now remain above the Settings modal instead of being hidden behind it. "
        "The standalone list-density View selector is retired; Minimal, Standard and Summary now live inside the existing single compact workbench menu, while + New remains direct. "
