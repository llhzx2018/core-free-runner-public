...
EXPECTED_SHA="01c6915a9843089064b539bb4811c70d993b9b8d"
EXPECTED_VERSION="2.5.80"
RUN_ROOT="${RUNNER_TEMP:-/tmp}/p02-v2580-detail-audit-${GITHUB_RUN_ID:-local}-$$"
SITE="$RUN_ROOT/site"
COOKIE="$RUN_ROOT/cookies.txt"
PORT=18180
BASE_URL="http://127.0.0.1:$PORT"
TEST_PASSWORD="P02-Audit-${GITHUB_RUN_ID:-local}-Safe!"
mkdir -p "$RUN_ROOT"
...
cp "$GITHUB_WORKSPACE/runner/requests/p02-v2580-detail-audit/audit.mjs" "$PRODUCT_ROOT/tests/e2e/p02_v2580_detail_audit_temp.mjs"
export VF_AUDIT_BASE_URL="$BASE_URL"
export VF_AUDIT_PASSWORD="$TEST_PASSWORD"
node tests/e2e/p02_v2580_detail_audit_temp.mjs
