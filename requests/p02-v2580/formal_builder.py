...
def main():
    ...
    notes.write_text(
        f"# VF Library V{version}\n\n"
        "Inkstone Fine Polish consolidation release. "
        "This release consolidates the V2.5.55–V2.5.80 fine-polish sequence across typography and optical density, compact command/control geometry, form consistency, theme continuity, low-noise toast and system-status language, save/update state semantics, record metadata, reader resume/series navigation, bulk selection, attachment workspace, logged-out auth entry, template picker, list pagination, import governance, and duplicate-governance comparison surfaces. "
        "The product IA, private single-admin model, Canonical Content authority, authentication boundary, updater contract and Schema 2401 remain unchanged; no migration is required.\n\n"
