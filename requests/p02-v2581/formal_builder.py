...
def main():
    ...
    notes.write_text(
        f"# VF Library V{version}\n\n"
        "System audit closure release. "
        "This release consolidates the final V2.5.81 detail and dark-path audit fixes across legacy category-delete Recent Auth, truthful updater integrity language, Local Edit Recovery terminology, repository-health regression coverage, Restore/Atomic pre-activation failure safety, attachment rename/replace transaction atomicity, and destructive-operation Step-up consistency. "
