...
try{
  ...
  await page.screenshot({path:out+'/01b-sidebar-rail-1440.png',fullPage:true});
  await page.locator('#collapsedSearchBtn').click();
  await page.waitForFunction(()=>!document.body.classList.contains('sidebar-collapsed')&&document.activeElement?.id==='globalSearch');
  await page.waitForTimeout(100);
  await page.screenshot({path:out+'/01c-sidebar-search-restored-1440.png',fullPage:true});
  ...
  console.log('P02_V2550_VISUAL_AUDIT_CAPTURE=PASS');
} finally {
  await browser.close();
}
