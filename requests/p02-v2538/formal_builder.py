...
def main():
    ...
    notes.write_text(
        f"# VF Library V{version}\n\n"
        "Inkstone-class workbench/editor consolidation release. "
        "List and Notebook top controls are consolidated into one compact workbench menu while + remains the direct create action. "
        "The editable document title is docked into the document header, formatting stays directly above one collapsible Properties row, "
        "and the desktop editor keeps a persistent outline rail and continuous writing plane. "
