...
def main():
    ...
    notes.write_text(
        f"# VF Library V{version}\n\n"
        "Post-V2.5.40 Inkstone UX closure. "
        "The editor outline rail is now conditional: when no useful table of contents exists, the 172px rail is removed and the writing surface reclaims the space; when a useful outline exists, the dedicated right rail remains available. "
        "All V2.5.40 shell, single-CSS runtime, authenticated boot, medium-width, mobile, compact workbench and Settings child-dialog layering behavior remains intact. "
        "The private single-admin data model, auth boundary, updater, canonical content model and Schema 2401 remain unchanged; no migration is required.\n\n"
