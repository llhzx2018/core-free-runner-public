...
SOURCE_SHA="63c0f167ec515dc07cbaf365759c1fa5b7775f05"
TARGET_BRANCH="chore/p02-v25121-source-manifest-r3-20260925"
...
git commit -m "chore(P02): refresh V2.5.121 source manifest after ownership closure"
git remote set-url origin "https://x-access-token:${VF_RELEASE_WRITE_TOKEN}@github.com/${REPO}.git"
git push origin "$TARGET_BRANCH"
echo P02_V25121_SOURCE_MANIFEST_SYNC_R3=PASS
