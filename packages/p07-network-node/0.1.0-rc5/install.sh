...
# Preserve the most useful historical UX: `v2ray url` can still print the
# client link. P07 also exposes the same action as `vf-node url`.
...
say "  ${C_MAGENTA}v2ray url${C_RESET}        保留原脚本兼容命令"
