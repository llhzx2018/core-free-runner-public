...
RC14 candidate boundary:
  ...
  - RC14 Safe Apply is CAP-ONLY and auto-write is restricted to the production-calibrated 1C/2GB Balanced CloudPanel lane.
  - uncalibrated profiles remain preview-only; Safe Apply never restarts MySQL or auto-mutates Swap / unused PHP services.
