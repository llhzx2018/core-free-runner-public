...
def recommend(snapshot: Mapping[str, Any], mode: str = "balanced") -> Dict[str, Any]:
    ...
    return {
        ...
        "evidence": {
            ...
            "production_calibration": "1C_2G_BALANCED_REFERENCE" if band == "2G" and cpu_count == 1 and mode == "balanced" else None,
        },
        "notes": notes,
...
def render_matrix(mode: str = "balanced") -> str:
    ...
    out = [
        ...
        "",
        "RAM   CPU   MySQL Buffer   Connections   Tmp   TableCache   Hot PHP   Swap",
        "----  ----  -------------  ------------  ----  -----------  --------  ----",
    ]
    for r in rows:
