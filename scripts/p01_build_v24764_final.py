...
BASE=Path("/tmp/p01-rel63/full")
OLD_REPAIR=Path("/tmp/p01-rel63/update/repair-v2.47.63.php")
OUT=Path("/tmp/p01-v24764-artifacts")
VERSION="2.47.64"
SOURCE_VERSION="2.47.63"
SCHEMA="2026090401"
SOURCE_SHA="8dc91930b94b59ab3e08234cddbdffd8d752b24e"
SOURCE_TREE="19101ab6a3e0c82c9e93449242ef084210eba4fc"
...
formal["release_scope"]="p01-v24764-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.62';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.63';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24764_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
