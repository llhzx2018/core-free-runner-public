...
OLD_REPAIR=Path("/tmp/p01-rel40/update/repair-v2.47.41.php")
OUT=Path("/tmp/p01-v24742-artifacts")
VERSION="2.47.42"
SOURCE_VERSION="2.47.41"
SCHEMA="2026090401"
SOURCE_SHA="63aece29b7562a800d6771a1479bcfc9faa26cab"
SOURCE_TREE="967e85600409342d1922804c2cd86f04de7263c5"
...
formal["release_scope"]="p01-v24742-machine-preflight"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.40';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.41';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24742_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
