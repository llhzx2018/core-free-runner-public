...
BASE=Path("/tmp/p01-rel52/full")
OLD_REPAIR=Path("/tmp/p01-rel52/update/repair-v2.47.52.php")
OUT=Path("/tmp/p01-v24753-artifacts")
VERSION="2.47.53"
SOURCE_VERSION="2.47.52"
SCHEMA="2026090401"
SOURCE_SHA="52e4b0ce086935589cfeb7ec2fb26ad3a8049fd6"
SOURCE_TREE="a252ca2799dad6886a24b6a698b917ae65c393f6"
...
formal["release_scope"]="p01-v24753-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.51';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.52';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24753_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
