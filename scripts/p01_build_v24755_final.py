...
BASE=Path("/tmp/p01-rel54/full")
OLD_REPAIR=Path("/tmp/p01-rel54/update/repair-v2.47.54.php")
OUT=Path("/tmp/p01-v24755-artifacts")
VERSION="2.47.55"
SOURCE_VERSION="2.47.54"
SCHEMA="2026090401"
SOURCE_SHA="2cdea016d3ae9d3587dd7f455078870828662a89"
SOURCE_TREE="02a8b5c469ccd89b42ce34f30f21f88b905b93e2"
...
formal["release_scope"]="p01-v24755-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.53';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.54';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24755_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
