...
BASE=Path("/tmp/p01-rel69/full")
OLD_REPAIR=Path("/tmp/p01-rel69/update/repair-v2.47.69.php")
OUT=Path("/tmp/p01-v24770-artifacts")
VERSION="2.47.70"
SOURCE_VERSION="2.47.69"
SCHEMA="2026090401"
SOURCE_SHA="120741a2fcf40f6d854e0b7201e54b396d4b2ec5"
SOURCE_TREE="9cca7bcd293bd2f55565ac1bbbe8ff03284e1f6b"
...
formal["release_scope"]="p01-v24770-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.68';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.69';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24770_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
