...
BASE=Path("/tmp/p01-rel43/full")
OLD_REPAIR=Path("/tmp/p01-rel43/update/repair-v2.47.43.php")
OUT=Path("/tmp/p01-v24744-artifacts")
VERSION="2.47.44"
SOURCE_VERSION="2.47.43"
SCHEMA="2026090401"
SOURCE_SHA="3180f1ceff867aa8a0de647c46355db6e2f4c83b"
SOURCE_TREE="fa67a88b42f079bc11b738bb622b3a324fde48db"
...
formal["release_scope"]="p01-v24744-machine-preflight"
...
(OUT/"P01_V24744_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
