...
OLD_REPAIR=Path("/tmp/p01-rel56/update/repair-v2.47.56.php")
OUT=Path("/tmp/p01-v24757-artifacts")
VERSION="2.47.57"
SOURCE_VERSION="2.47.56"
SCHEMA="2026090401"
SOURCE_SHA="109aecb8b6b86dc3ceb6192a1e94c849d5850e55"
SOURCE_TREE="999a6a90850a47c948509e9a6096126fc14957dd"
...
formal["release_scope"]="p01-v24757-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.55';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.56';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24757_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
