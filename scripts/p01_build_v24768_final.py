...
BASE=Path("/tmp/p01-rel67/full")
OLD_REPAIR=Path("/tmp/p01-rel67/update/repair-v2.47.67.php")
OUT=Path("/tmp/p01-v24768-artifacts")
VERSION="2.47.68"
SOURCE_VERSION="2.47.67"
SCHEMA="2026090401"
SOURCE_SHA="ef23fd09511bf7557b47cb22915a4cffb5e10797"
SOURCE_TREE="4b3b9d65c7f1c8dbe8ef9d0db308ebdc6a409c2c"
...
formal["release_scope"]="p01-v24768-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.66';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.67';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24768_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
