...
BASE=Path("/tmp/p01-rel62/full")
OLD_REPAIR=Path("/tmp/p01-rel62/update/repair-v2.47.62.php")
OUT=Path("/tmp/p01-v24763-artifacts")
VERSION="2.47.63"
SOURCE_VERSION="2.47.62"
SCHEMA="2026090401"
SOURCE_SHA="2777b269d4eba0409bda3082b6d71abdfa028f32"
SOURCE_TREE="6a1e672e17920437e025aa17f6bbd93b850abd61"
...
formal["release_scope"]="p01-v24763-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.61';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.62';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24763_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
