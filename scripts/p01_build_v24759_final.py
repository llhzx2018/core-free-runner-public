...
BASE=Path("/tmp/p01-rel58/full")
OLD_REPAIR=Path("/tmp/p01-rel58/update/repair-v2.47.58.php")
OUT=Path("/tmp/p01-v24759-artifacts")
VERSION="2.47.59"
SOURCE_VERSION="2.47.58"
SCHEMA="2026090401"
SOURCE_SHA="94d41d119fd9098ba3f8341187b8891455012acc"
SOURCE_TREE="cdcc79a718987ca3cd576ffac19c47c1dc182796"
...
formal["release_scope"]="p01-v24759-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.57';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.58';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24759_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
