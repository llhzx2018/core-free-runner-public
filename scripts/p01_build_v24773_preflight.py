...
BASE=Path("/tmp/p01-rel72/full")
OLD_REPAIR=Path("/tmp/p01-rel72/update/repair-v2.47.72.php")
OUT=Path("/tmp/p01-v24773-artifacts")
VERSION="2.47.73"
SOURCE_VERSION="2.47.72"
SCHEMA="2026090401"
SOURCE_SHA="5a90fa61b0e446444b49f8de58438d2de5e9acda"
SOURCE_TREE="9e6fe0e775e95dfb237471a569f604062f267218"
...
def zip_deterministic(path:Path, files:dict[str,bytes]):
    with zipfile.ZipFile(path,"w",compression=zipfile.ZIP_DEFLATED,compresslevel=9) as z:
        for rel in sorted(files):
            info=zipfile.ZipInfo(rel,(2026,9,25,0,0,0))
...
formal["release_scope"]="p01-v24773-artifact-preflight"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.71';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.72';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24773_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
