...
OLD_REPAIR=Path("/tmp/p01-rel48/update/repair-v2.47.48.php")
OUT=Path("/tmp/p01-v24749-artifacts")
VERSION="2.47.49"
SOURCE_VERSION="2.47.48"
SCHEMA="2026090401"
SOURCE_SHA="1f04c97472ee0597fd1238e993839322443629ce"
SOURCE_TREE="8c174b1e28ec50b97b33ac8db96593166e5582b2"
...
formal["release_scope"]="p01-v24749-final-release"
...
for a,b in [
    ...
    ("public const TARGET_VERSION='2.47.48';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24749_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
