...
BASE=Path("/tmp/p01-rel68/full")
OLD_REPAIR=Path("/tmp/p01-rel68/update/repair-v2.47.68.php")
OUT=Path("/tmp/p01-v24769-artifacts")
VERSION="2.47.69"
SOURCE_VERSION="2.47.68"
SCHEMA="2026090401"
SOURCE_SHA="e0a5e15237f5e1dd10db884bb598e4baca8f74e9"
SOURCE_TREE="13313a9418f9dcd5d212e38ddf4e8c0d941bd45b"
...
formal["release_scope"]="p01-v24769-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.67';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.68';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24769_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
