...
if($before['links']!==24||$before['categories']!==2||$before['favorites']!==3||$before['private']!==4||$before['profiles']!==16||$before['schema']!=='2026082901')throw new RuntimeException('seed '.json_encode($before));
