...
BASE=Path("/tmp/p01-rel51/full")
OLD_REPAIR=Path("/tmp/p01-rel51/update/repair-v2.47.51.php")
OUT=Path("/tmp/p01-v24752-artifacts")
VERSION="2.47.52"
SOURCE_VERSION="2.47.51"
SCHEMA="2026090401"
SOURCE_SHA="3d1f59364d6c328cc87bb07327ffa0be8d4faa5f"
SOURCE_TREE="772d139f6b055bbace8c0fc8c30c7232e255fa20"
...
formal["release_scope"]="p01-v24752-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.50';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.51';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24752_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
