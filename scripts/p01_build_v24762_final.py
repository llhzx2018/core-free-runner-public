...
BASE=Path("/tmp/p01-rel61/full")
OLD_REPAIR=Path("/tmp/p01-rel61/update/repair-v2.47.61.php")
OUT=Path("/tmp/p01-v24762-artifacts")
VERSION="2.47.62"
SOURCE_VERSION="2.47.61"
SCHEMA="2026090401"
SOURCE_SHA="9bf4f15f8ad62999d179c51eaedaca92582ccd1f"
SOURCE_TREE="6654ad5ab85cf8c835ef6405156e586786733fc0"
...
formal["release_scope"]="p01-v24762-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.60';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.61';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24762_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
