...
BASE=Path("/tmp/p01-rel70/full")
OLD_REPAIR=Path("/tmp/p01-rel70/update/repair-v2.47.70.php")
OUT=Path("/tmp/p01-v24771-artifacts")
VERSION="2.47.71"
SOURCE_VERSION="2.47.70"
SCHEMA="2026090401"
SOURCE_SHA="2562291f03177d6970fedc337c728fde10168bdc"
SOURCE_TREE="fc69bc1655b11e3fcca232c286758e9afda68858"
...
formal["release_scope"]="p01-v24771-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.69';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.70';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24771_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
