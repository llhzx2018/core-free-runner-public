...
BASE=Path("/tmp/p01-rel42/full")
OLD_REPAIR=Path("/tmp/p01-rel42/update/repair-v2.47.42.php")
OUT=Path("/tmp/p01-v24743-artifacts")
VERSION="2.47.43"
SOURCE_VERSION="2.47.42"
SCHEMA="2026090401"
SOURCE_SHA="221301fba18dd3c73307ecf06b3f9185630ff485"
SOURCE_TREE="2e2bc8630a74d23ad111f963ee33d120ee8383f3"
...
formal["release_scope"]="p01-v24743-machine-preflight"
...
for a,b in [
    ...
    ("public const TARGET_VERSION='2.47.42';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24743_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
