...
BASE=Path("/tmp/p01-rel50/full")
OLD_REPAIR=Path("/tmp/p01-rel50/update/repair-v2.47.50.php")
OUT=Path("/tmp/p01-v24751-artifacts")
VERSION="2.47.51"
SOURCE_VERSION="2.47.50"
SCHEMA="2026090401"
SOURCE_SHA="8e9c78faf8e5ffd1b5ba80460e2034fd4227732c"
SOURCE_TREE="1ce62eb826bff8942357401c73059d05c63aded2"
...
formal["release_scope"]="p01-v24751-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.49';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.50';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24751_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
