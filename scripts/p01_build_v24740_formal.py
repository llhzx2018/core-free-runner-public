...
BASE=Path("/tmp/p01-rel39/full")
OLD_REPAIR=Path("/tmp/p01-rel39/update/repair-v2.47.39.php")
OUT=Path("/tmp/p01-v24740-artifacts")
VERSION="2.47.40"
SOURCE_VERSION="2.47.39"
SCHEMA="2026090401"
SOURCE_SHA="73bdfa38310aaabcf6df48810fe8479024a1a819"
...
formal["release_scope"]="p01-v24740-formal-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.38';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.39';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24740_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
