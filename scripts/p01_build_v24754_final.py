...
BASE=Path("/tmp/p01-rel53/full")
OLD_REPAIR=Path("/tmp/p01-rel53/update/repair-v2.47.53.php")
OUT=Path("/tmp/p01-v24754-artifacts")
VERSION="2.47.54"
SOURCE_VERSION="2.47.53"
SCHEMA="2026090401"
SOURCE_SHA="97052dc7fa67f791dc7dd86b0525d6a4bcb107ce"
SOURCE_TREE="f9f3d9cf22ba9d8218eef37253475a5207d50f1d"
...
formal["release_scope"]="p01-v24754-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.52';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.53';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24754_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
