...
BASE=Path("/tmp/p01-rel60/full")
OLD_REPAIR=Path("/tmp/p01-rel60/update/repair-v2.47.60.php")
OUT=Path("/tmp/p01-v24761-artifacts")
VERSION="2.47.61"
SOURCE_VERSION="2.47.60"
SCHEMA="2026090401"
SOURCE_SHA="fcccffea71ea147db3797b59a21e676e75a18844"
SOURCE_TREE="7ce37dcabf46dd60f17c1d17e9f699269650b57a"
...
formal["release_scope"]="p01-v24761-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.59';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.60';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24761_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
