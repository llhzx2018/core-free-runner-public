...
BASE=Path("/tmp/p01-rel71/full")
OLD_REPAIR=Path("/tmp/p01-rel71/update/repair-v2.47.71.php")
OUT=Path("/tmp/p01-v24772-artifacts")
VERSION="2.47.72"
SOURCE_VERSION="2.47.71"
SCHEMA="2026090401"
SOURCE_SHA="cd176611a24be2dd90155ce84b6b89fab2915150"
SOURCE_TREE="755ec90d9af490b5cd177aaf17d55e217fe49d33"
...
formal["release_scope"]="p01-v24772-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.70';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.71';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24772_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
