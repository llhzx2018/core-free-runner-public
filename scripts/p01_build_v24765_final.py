...
BASE=Path("/tmp/p01-rel64/full")
OLD_REPAIR=Path("/tmp/p01-rel64/update/repair-v2.47.64.php")
OUT=Path("/tmp/p01-v24765-artifacts")
VERSION="2.47.65"
SOURCE_VERSION="2.47.64"
SCHEMA="2026090401"
SOURCE_SHA="617f21d753d43fe7bc4e89f24aeb287f2a9d57af"
SOURCE_TREE="98b42c9d0fef6f2c3b615ba24f989b83b5215ef7"
...
formal["release_scope"]="p01-v24765-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.63';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.64';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24765_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
