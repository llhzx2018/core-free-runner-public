...
BASE=Path("/tmp/p01-rel46/full")
OLD_REPAIR=Path("/tmp/p01-rel46/update/repair-v2.47.46.php")
OUT=Path("/tmp/p01-v24747-artifacts")
VERSION="2.47.47"
SOURCE_VERSION="2.47.46"
SCHEMA="2026090401"
SOURCE_SHA="3e4ffd768a29d82aeb439bf97cc1e690ad0ddc10"
SOURCE_TREE="cce12ac706cec24c0d3b30802a0fccf8599c5fc3"
...
formal["release_scope"]="p01-v24747-machine-preflight"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.45';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.46';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24747_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
