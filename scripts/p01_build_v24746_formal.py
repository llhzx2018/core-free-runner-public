...
BASE=Path("/tmp/p01-rel45/full")
OLD_REPAIR=Path("/tmp/p01-rel45/update/repair-v2.47.45.php")
OUT=Path("/tmp/p01-v24746-artifacts")
VERSION="2.47.46"
SOURCE_VERSION="2.47.45"
SCHEMA="2026090401"
SOURCE_SHA="2e31cf1b78fc4fc1958138e99a7fd1fd1c57efa1"
SOURCE_TREE="1e45242ff2271cd287181935a0865dcaf44bfa76"
...
formal["release_scope"]="p01-v24746-machine-preflight"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.44';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.45';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24746_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
