...
BASE=Path("/tmp/p01-rel65/full")
OLD_REPAIR=Path("/tmp/p01-rel65/update/repair-v2.47.65.php")
OUT=Path("/tmp/p01-v24766-artifacts")
VERSION="2.47.66"
SOURCE_VERSION="2.47.65"
SCHEMA="2026090401"
SOURCE_SHA="50553f3b070a26e500b36ed8d0a1873683dd2366"
SOURCE_TREE="d2a4f5bddc70a63296c823c5bb56cae8a2ad5ace"
...
formal["release_scope"]="p01-v24766-final-release"
...
(OUT/"P01_V24766_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
