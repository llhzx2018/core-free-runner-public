...
BASE=Path("/tmp/p01-rel55/full")
OLD_REPAIR=Path("/tmp/p01-rel55/update/repair-v2.47.55.php")
OUT=Path("/tmp/p01-v24756-artifacts")
VERSION="2.47.56"
SOURCE_VERSION="2.47.55"
SCHEMA="2026090401"
SOURCE_SHA="910392486d0b49026f4d50fdd2997165ef909fd2"
SOURCE_TREE="fe0ef962751ce8e51559e0c8596b13639ba8b3f8"
...
formal["release_scope"]="p01-v24756-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.54';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.55';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24756_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
