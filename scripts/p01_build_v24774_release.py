...
BASE=Path("/tmp/p01-rel73/full")
OLD_REPAIR=Path("/tmp/p01-rel73/update/repair-v2.47.73.php")
OUT=Path("/tmp/p01-v24774-artifacts")
VERSION="2.47.74"
SOURCE_VERSION="2.47.73"
SCHEMA="2026090401"
SOURCE_SHA="97931667c7d8ecc961aba6e88581f74126b41bad"
SOURCE_TREE="9a529bb997350e24db6c6ff18e1e2e556afb813a"
...
formal["release_scope"]="p01-v24774-formal-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.72';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.73';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24774_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
