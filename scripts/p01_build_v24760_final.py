...
BASE=Path("/tmp/p01-rel59/full")
OLD_REPAIR=Path("/tmp/p01-rel59/update/repair-v2.47.59.php")
OUT=Path("/tmp/p01-v24760-artifacts")
VERSION="2.47.60"
SOURCE_VERSION="2.47.59"
SCHEMA="2026090401"
SOURCE_SHA="101588a276f7c15463d4b0e54a75623612abbd3a"
SOURCE_TREE="24287d897b5b5417963f071ef2fc1e9d2b2e93f8"
...
formal["release_scope"]="p01-v24760-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.58';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.59';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24760_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
