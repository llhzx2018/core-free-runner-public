...
base = load_module('p01_base_maintenance_22119', HERE / 'p01-build-release.py')
v2 = load_module('p01_v2_atomic_maintenance_22119', HERE / 'p01-build-release-v2.py')
...
def main() -> None:
    ...
    notes = (
        ...
        f'- Target: V{VERSION}\n'
        '- Scope: reference-driven homepage, navigation, links-management and responsive visual refinement\n'
        '- Reference model: Start.me navigation clarity + Raindrop asset-workspace logic + one WordPress-style AdminShell\n'
