...
BASE=Path("/tmp/p01-rel44/full")
OLD_REPAIR=Path("/tmp/p01-rel44/update/repair-v2.47.44.php")
OUT=Path("/tmp/p01-v24745-artifacts")
VERSION="2.47.45"
SOURCE_VERSION="2.47.44"
SCHEMA="2026090401"
SOURCE_SHA="41d4253b8439deb098a44db6aa25acb94cc5ce93"
SOURCE_TREE="c94a3711bc242947602d8d9eeff40db95f550963"
...
formal["release_scope"]="p01-v24745-machine-preflight"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.43';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.44';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24745_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
