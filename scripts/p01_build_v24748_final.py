...
BASE=Path("/tmp/p01-rel47/full")
OLD_REPAIR=Path("/tmp/p01-rel47/update/repair-v2.47.47.php")
OUT=Path("/tmp/p01-v24748-artifacts")
VERSION="2.47.48"
SOURCE_VERSION="2.47.47"
SCHEMA="2026090401"
SOURCE_SHA="760f4937a71c9d1fdd99ab17cb865cdcb26ec8c0"
SOURCE_TREE="a9e03df5cc4bf72dbb2a521ae624e8d997c69683"
...
formal["release_scope"]="p01-v24748-final-release"
...
repair=old
for a,b in [
    ("public const SOURCE_VERSION='2.47.46';",f"public const SOURCE_VERSION='{SOURCE_VERSION}';"),
    ("public const TARGET_VERSION='2.47.47';",f"public const TARGET_VERSION='{VERSION}';"),
...
(OUT/"P01_V24748_ARTIFACT_RECEIPT.json").write_text(json.dumps(receipt,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
